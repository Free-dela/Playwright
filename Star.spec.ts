...
test('1A Assure', async ({ page }) => {
  await FillHealthInsuranceForm1(page);
    await fillById(page,'#mat-input-18','09121999');
      await Product(page,"₹ 7676/Yr","₹ 8940/Yr");
  ...
  await FillHealthInsuranceForm1(page);
    await fillById(page,'#mat-input-18','09121999');
      await fillById(page,'#mat-input-20','09121999');
        await Product(page,"₹ 12930/Yr","₹ 13280/Yr");
          await CkycProposer(page);
            await Insurer2(page);
              await Nominee(page);
                await Payment(page);
...
test('1A Comprehensive', async ({ page }) => {
  await FillHealthInsuranceForm1(page);
    await fillById(page,'#mat-input-18','09121999');
      await Product(page,"₹ 8940/Yr","₹ 7676/Yr");
        await CkycProposer(page);
...
test.only('2A Comprehensive', async ({ page }) => {
  await FillHealthInsuranceForm1(page);
    await fillById(page,'#mat-input-18','09121999');
      await fillById(page,'#mat-input-20','09121999');
        await Product(page,"₹ 13280/Yr","₹ 12930/Yr");
          await CkycProposer(page);
