...
export async function FillHealthInsuranceForm1(page) {
  ...
  await fillByRole(page, 'textbox', 'Email ID', 'sirajabhi4@gmail.com');
  // await fillByRole(page, 'textbox', 'Email ID', 'sakthikrishnavizza@gmail.com');
...
export async function CkycProposer(page) {
  await clickBySelector(page, '#mat-radio-16 > .mat-radio-label > .mat-radio-container > .mat-radio-outer-circle');
...
export async function Insurer1(page) {
  ...
  await page.locator('#mat-radio-37 > .mat-radio-label > .mat-radio-container').click();
  await page.locator('#mat-radio-39 > .mat-radio-label > .mat-radio-container > .mat-radio-outer-circle').click();
...
export async function Insurer1C(page) {
  ...
  await fillByRole(page, 'textbox', 'Height(cms)', '170');
  await fillByRole(page, 'textbox', 'Weight(kgs)', '70');
  await selectRadioButton(page,57);
  await selectRadioButton(page,72);
  await selectRadioButton(page,75);
  await selectRadioButton(page,78);
  await selectRadioButton(page,63);
...
export async function Insurer2C(page) {
  ...
  await page.getByLabel('2. INSURED DETAILS').getByLabel('Relationship with Proposer').getByText('Relationship with Proposer').click();
  await page.getByText('SPOUSE').click();
  await page.locator('#mat-radio-108 > .mat-radio-label > .mat-radio-container > .mat-radio-outer-circle').click();
  await page.getByLabel('2INSURED DETAILS').getByRole('button', { name: 'Next' }).scrollIntoViewIfNeeded
  await page.getByLabel('2INSURED DETAILS').getByRole('button', { name: 'Next' }).click();
}
export async function Product  (page, Premium1: string ,Premium2: string) {
  ...
  await clickNestedElement(page, 'option', 'Star Health', 'mat-pseudo-checkbox');
